...
- 기술면접 : TCP/UDP, OSI 7계층 간단히 계층별 설명, 왜 물리학과에서 컴공으로 전향햇는지, 사용해본 언어 뭐있는지, 파이썬 사용해보면서 numpy도 사용 해봣겟네요, 가장 자신있는 기술 스택, 가장 어려운 컴퓨터공학 과목, NoSQL 사용 해봣나요, ORM에서 JPA 사용 해봣나요, 웹 게시판 CRUD 기능 만드는데 예상되는 시간은?, RESTful API를 만들어 본 적이 있나요?, 객체지향(JAVA) 상속과 인터페이스 차이? DAO가 무엇?
