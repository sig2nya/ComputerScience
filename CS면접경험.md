...
22.03.04 '유명 그룹사 보안 기업(교육 후 채용형 교육생)' 면접 경험(합격)
================================================
*(대기업이라지만 흠... 글쎄)
...
- 면접 전에 PPT발표 준비 시킴.
- 해당 회사는 자체 프레임워크를 사용한다고 하였음
- navigation 관련 JSP 30분 코딩 시험
...
22.03.11 컨택센터 구축 / 유지보수 및 운용 시스템 엔지니어 채용 연계형 인턴(합격 - Confirm)
===============================================================================
...
22.03.21 KITRI 채용 연계형 교육과정 면접(합)
===========================================
- 간단히 지원동기 물어봄
...
22.03.21 보안 솔루션 회사(합 - 입사 Cancle)
=============================
- 회사에 대해 아는 것? 회사에서 하고싶은 것?
- 기술면접 : TCP/UDP, OSI 7계층 간단히 계층별 설명, 왜 물리학과에서 컴공으로 전향햇는지, 사용해본 언어 뭐있는지, 파이썬 사용해보면서 numpy도 사용 해봣겟네요, 가장 자신있는 기술 스택, 가장 어려운 컴퓨터공학 과목, NoSQL 사용 해봣나요, ORM에서 JPA 사용 해봣나요, 웹 게시판 CRUD 기능 만드는데 예상되는 시간은?, RESTful API를 만들어 본 적이 있나요?, 객체지향(JAVA) 상속과 인터페이스 차이? DAO가 무엇? 스프링과 부트의 차이점?
- 한줄평 : 기술 / 인성면접 대체적으로 무난함의 끝판왕 면접이었다. 집앞 도보로 7분 거리에 있는 회사, 거리 상으로는 진짜 최적의 회사이다.

22.05.27 여의도 중견정도 증권사(불합)
==================
- 핀테크 어플 사용 경험에서 UI에 대해 깊은 인상을 받은 어플과 왜 좋았는지?
- 주로 인성 면접 : 1분 자기소개 / 꿈이 뭔지 / 버킷 리스트 / 이 증권사에서 채용형 인턴으로 근무할텐데 채용형이어도 떨어질 확률이 있다. 현재 다니고 있는 직장을 포기하고 올 의사가 있는지 / 특기와 취미
- 기술 면접 : 자소서 바탕으로 프로젝트에 대한 얇은 검증. 하지만, 나는 금융쪽 프로젝트는 전무하여 질문을 받지 못하였고, 같이 면접 봤던 Candidates들 몇몇에게 간단히 프로젝트 물어보고 검증정도 하는 질문
- 한줄평 : 증권 / 금융사는 나에게 있어 너무 높은 벽이었던 것 같다.
